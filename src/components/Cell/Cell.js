...
const cell = (props) => (
    <tr  className={classes.Table}>
        ...
        <td onClick={props.clicked}className={classes.noWrap} style={{textAlign : "center"}}>U$ {props.coin.last}        <p className={props.coin.negativeChange ? classes.red : classes.green}>{props.coin.percentChange}%</p></td>
